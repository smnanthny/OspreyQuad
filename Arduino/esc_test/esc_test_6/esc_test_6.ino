// Mixing Y and X axis values to obtain individual ESC values.
// Removed standby function for this test.
// 
// Date: 21/11/2013
...
byte yJoy, xJoy, zBtn; // store input data in these variables
...
void loop() {
    if( freqCount >= 20 ) { // update input data every 20ms
        ...
        yJoy = nunchuck_joyy(); // ranges from approx 33 - 227
